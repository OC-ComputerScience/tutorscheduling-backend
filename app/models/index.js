...
db.personroleprivilege = require("./personroleprivilege.model.js")(
  sequelize,
  Sequelize
);
...
db.personappointment = require("./personappointment.model.js")(
  sequelize,
  Sequelize
);
...
db.personrole.hasMany(
  db.personroleprivilege,
  { as: "personroleprivilege" },
  { foreignKey: { allowNull: false }, onDelete: "CASCADE" }
);
db.personroleprivilege.belongsTo(
  db.personrole,
  { as: "personrole" },
  { foreignKey: { allowNull: false }, onDelete: "CASCADE" }
);
...
db.appointment.hasMany(
  db.personappointment,
...
db.personappointment.belongsTo(
  db.appointment,
  { as: "appointment" },
  { onDelete: "cascade", foreignKey: { allowNull: false }, hooks: true }
);
