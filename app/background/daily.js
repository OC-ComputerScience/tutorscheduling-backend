...
async function notifyForFeedback() {
  ...
  tutors.forEach((tutor) => {
    let message = {
      message: "Please leave feedback for " + tutor.personappointment.length + " appointment(s). " + url,
  ...
  students.forEach((student) => {
    let message = {
      message: "Please leave feedback for " + student.personappointment.length + " appointment(s). " + url,
